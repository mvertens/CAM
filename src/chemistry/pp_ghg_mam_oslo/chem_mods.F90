...
!--------------------------------------------------------------
      ...
      integer, parameter :: phtcnt = 1, & ! number of photolysis reactions
                            rxntot = 18, & ! number of total reactions
                            gascnt = 17, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 35, & ! number of "gas phase" species
                            nfs = 8, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 43, & ! number of non-zero matrix entries
                            ...
                            clscnt4 = 34, & ! number of species in implicit class
