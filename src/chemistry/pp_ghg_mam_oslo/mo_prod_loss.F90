...
!--------------------------------------------------------------------
         loss(1) = ( + rxt(9) + rxt(10) + rxt(12) + het_rates(3))* y(3)
         prod(1) = 0._r8
         loss(2) = ( + rxt(11) + het_rates(1))* y(1)
         prod(2) = (rxt(9) +rxt(10) +.750_r8*rxt(12))*y(3)
         loss(3) = ( + rxt(1) + rxt(8) + het_rates(4))* y(4)
         prod(3) = 0._r8
         ...
         prod(26) =.029_r8*rxt(12)*y(3) +.150_r8*rxt(13)*y(28)
         loss(27) = ( + het_rates(27))* y(27)
         prod(27) = (.025_r8*rxt(16) +.025_r8*rxt(17) +.025_r8*rxt(18))*y(29) &
                  + (.150_r8*rxt(14) +.150_r8*rxt(15))*y(28) +.114_r8*rxt(12)*y(3)
         loss(28) = ( + rxt(13) + rxt(14) + rxt(15) + het_rates(28))* y(28)
         prod(28) = 0._r8
         loss(29) = ( + rxt(16) + rxt(17) + rxt(18) + het_rates(29))* y(29)
         prod(29) = 0._r8
         loss(30) = ( + rxt(4) + het_rates(30))* y(30)
         prod(30) = 0._r8
         loss(31) = ( + rxt(5) + het_rates(31))* y(31)
         prod(31) = 0._r8
         loss(32) = ( + rxt(6) + het_rates(32))* y(32)
         prod(32) = 0._r8
         loss(33) = ( + rxt(3) + het_rates(34))* y(34)
         prod(33) = 0._r8
         loss(34) = ( + rxt(2) + het_rates(35))* y(35)
         prod(34) =rxt(8)*y(4) +2.000_r8*rxt(6)*y(32)
