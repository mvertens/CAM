...
!-------------------------------------------------------------------------------
   ...
   character(len=cl)  :: co2flux_ocn_datafile = 'unset'  ! co2 flux from ocn
   character(len=cl)  :: co2flux_ocn_meshfile = 'unset'  ! ESMF mesh corresponding to co2flux_ocn_datafile
